...
class BacktestEngine:
    ...
    def _simulate_trade_daily_fallback(self, code: str, stock_name: str, entry_price: float,
        ...
        """[v3.2 委托] 日线单笔交易仿真委托给 app.backtest.simulate_one_trade 唯一 kernel。"""
        from app.backtest.simulate_one_trade import simulate_one_trade
        return simulate_one_trade(
            code=code, stock_name=stock_name, entry_price=entry_price,
            signal_date=signal_date, bars_daily=bars_daily,
            params_override=params_override, time_exit_min_pnl=time_exit_min_pnl,
